...
CANONICAL_SCHEMAS: dict[str, TableSchema] = {
    ...
    "derivatives_eod": TableSchema(
        name="derivatives_eod",
        grain="One row per derivative contract per trade_date.",
        primary_key=("contract_id", "trade_date"),
        columns=(
            ColumnDefinition("contract_id", "TEXT", False),
            ColumnDefinition("instrument_id", "TEXT"),
            ColumnDefinition("trade_date", "DATE", False),
            ColumnDefinition("segment", "TEXT"),
            ColumnDefinition("expiry_date", "DATE"),
            ColumnDefinition("strike_price", "DECIMAL"),
            ColumnDefinition("option_type", "TEXT"),
            ColumnDefinition("settlement_price", "DECIMAL"),
            ColumnDefinition("open_interest", "BIGINT"),
            ColumnDefinition("oi_change", "BIGINT"),
            ColumnDefinition("contract_volume", "BIGINT"),
        ),
    ),
    ...
    "score_snapshots": TableSchema(
        ...
        columns=(
            ...
            ColumnDefinition("peer_score", "DECIMAL"),
            ColumnDefinition("composite_score", "DECIMAL"),
            ColumnDefinition("confidence_score", "DECIMAL"),
            ColumnDefinition("classification", "TEXT"),
            ColumnDefinition("conflict_count", "INTEGER"),
            ColumnDefinition("conflicts_json", "JSON"),
            ColumnDefinition("abstain_reasons_json", "JSON"),
            ColumnDefinition("missing_components_json", "JSON"),
            ColumnDefinition("positive_drivers_json", "JSON"),
            ColumnDefinition("negative_drivers_json", "JSON"),
