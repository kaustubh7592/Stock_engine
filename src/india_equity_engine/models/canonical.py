...
CANONICAL_SCHEMAS: dict[str, TableSchema] = {
    ...
    "insider_trades": TableSchema(
        name="insider_trades",
        grain="One row per insider transaction record.",
        primary_key=("insider_trade_id",),
        columns=(
            ColumnDefinition("insider_trade_id", "TEXT", False),
            ColumnDefinition("instrument_id", "TEXT"),
            ColumnDefinition("filing_id", "TEXT"),
            ColumnDefinition("insider_name", "TEXT"),
            ColumnDefinition("insider_category", "TEXT"),
            ColumnDefinition("transaction_date", "DATE"),
            ColumnDefinition("transaction_type", "TEXT"),
            ColumnDefinition("quantity", "BIGINT"),
            ColumnDefinition("price", "DECIMAL"),
            ColumnDefinition("value_num", "DECIMAL"),
    ...
    "macro_series": TableSchema(
        ...
        primary_key=("series_code", "observation_date", "vintage_date"),
        columns=(
            ColumnDefinition("series_code", "TEXT", False),
            ColumnDefinition("series_name", "TEXT"),
            ColumnDefinition("source_family", "TEXT"),
            ColumnDefinition("observation_date", "DATE", False),
            ColumnDefinition("value_num", "DECIMAL"),
            ColumnDefinition("unit", "TEXT"),
            ColumnDefinition("frequency", "TEXT"),
            ColumnDefinition("vintage_date", "DATE", False),
            ColumnDefinition("seasonal_adjustment", "TEXT"),
        ),
    ),
    "market_flows": TableSchema(
        name="market_flows",
        grain="One row per date per flow slice.",
        primary_key=("trade_date", "flow_type", "segment", "investor_class"),
        columns=(
            ColumnDefinition("trade_date", "DATE", False),
            ColumnDefinition("flow_type", "TEXT", False),
            ColumnDefinition("segment", "TEXT", False),
            ColumnDefinition("investor_class", "TEXT", False),
            ColumnDefinition("gross_buy", "DECIMAL"),
            ColumnDefinition("gross_sell", "DECIMAL"),
            ColumnDefinition("net_flow", "DECIMAL"),
            ColumnDefinition("notes", "TEXT"),
        ),
    ),
    "news_items": TableSchema(
        name="news_items",
        grain="One row per ingested event/news item.",
        primary_key=("news_id",),
        columns=(
            ColumnDefinition("news_id", "TEXT", False),
            ColumnDefinition("published_at", "TIMESTAMP"),
            ColumnDefinition("source_name", "TEXT"),
            ColumnDefinition("source_class", "TEXT"),
            ColumnDefinition("headline", "TEXT"),
            ColumnDefinition("url", "TEXT"),
            ColumnDefinition("language_code", "TEXT"),
            ColumnDefinition("geography", "TEXT"),
            ColumnDefinition("event_type", "TEXT"),
            ColumnDefinition("sentiment_score", "DECIMAL"),
            ColumnDefinition("novelty_score", "DECIMAL"),
            ColumnDefinition("entities_json", "JSON"),
        ),
    ),
    "event_signals": TableSchema(
        name="event_signals",
        grain="One row per stock-linked event interpretation.",
        primary_key=("event_signal_id",),
        columns=(
            ColumnDefinition("event_signal_id", "TEXT", False),
            ColumnDefinition("news_id", "TEXT", False),
            ColumnDefinition("instrument_id", "TEXT"),
            ColumnDefinition("sector_name", "TEXT"),
            ColumnDefinition("event_date", "DATE"),
            ColumnDefinition("horizon", "TEXT"),
            ColumnDefinition("impact_direction", "TEXT"),
            ColumnDefinition("impact_score", "DECIMAL"),
            ColumnDefinition("confidence", "DECIMAL"),
            ColumnDefinition("exposure_channel", "TEXT"),
            ColumnDefinition("rationale_code", "TEXT"),
        ),
    ),
